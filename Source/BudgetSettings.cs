// /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Project: SpaceProgramFunding -- BudgetSettings.cs
// 
...
namespace SpaceProgramFunding.Source
{
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	/// <summary>
	///     Manager for the settings that likely will not change. These settings are editable through the
	///     Settings Pop-up Dialog or by editing the .cfg files directly.
	/// </summary>
	...
	internal class BudgetSettings : MonoBehaviour
	{
		...
		{
			Easy, // Minimal penalties... just free income
			Normal, // Balanced game-play
			Hard // Hard game-play... necessary to keep reputation up
		}
		...
		///////////////////////////////////////////////////////////////////////////////////////////
		/// <summary>
		///     The active vessel cost is determined from the mass of the vessel expressed as cost
		...
		///     imply low-maintenance missions so have less maintenance cost, as they should.
		/// </summary>
		/// ----------------------------------------------------------------------------------------
		...
		///////////////////////////////////////////////////////////////////////////////////////////
		/// <summary>
		///     The assigned kerbal wage is paid to each Kerbal that is on a mission (not in the
		///     Astronaut Complex). The wage is multiplied by the XP level of the Kerbal.
		/// </summary>
		/// ----------------------------------------------------------------------------------------
		...
		///////////////////////////////////////////////////////////////////////////////////////////
		/// <summary>
		///     The base kerbal wage is paid to each Kerbal that is sitting around in the Astronaut
		///     Complex. The wage is multiplied by the XP level of the Kerbal.
		/// </summary>
		/// ----------------------------------------------------------------------------------------
		...
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////
		/// <summary>
		///     The emergency budget is capped at a multiple of the gross budget. This prevents the exploit of
		///     letting the emergency budget accumulate indefinitely. The value is the number of reputation
		///     points per multiple. For example, reputation of 150 would be 3x multiple for a value of 50.
		/// </summary>
		...
		///////////////////////////////////////////////////////////////////////////////////////////
		/// <summary>
		///     The budget is run every month (typically). This specifies the number of days in a
		///     budget period.
		/// </summary>
		/// ----------------------------------------------------------------------------------------
		...
		///////////////////////////////////////////////////////////////////////////////////////////
		/// <summary>
		///     The budget funds to grant is based on a multiple of the current reputation value. To
		///     get more budget, get a higher reputation.
		/// </summary>
		/// ----------------------------------------------------------------------------------------
		...
		///////////////////////////////////////////////////////////////////////////////////////////
		/// <summary>
		///     Fee cost to moving money into the emergency budget fund. This needs to be large
		///     enough to discourage keeping maximum funds flowing into emergency budget. The
		///     emergency budget should just be used for big projects.
		/// </summary>
		/// ----------------------------------------------------------------------------------------
		...
		///////////////////////////////////////////////////////////////////////////////////////////
		/// <summary>
		///     Should the budget period be logged in Kerbal Alarm Clock? If true, the player will be aware when the budget
		///     period will end.
		/// </summary>
		/// ----------------------------------------------------------------------------------------
		...
		///////////////////////////////////////////////////////////////////////////////////////////
		/// <summary>
		///     Should maintenance costs be applied for the Kerbal Space Center? This makes upgrading
		///     the space center have a tradeoff due to higher maintenance costs. Maintenance
		///     costs are a non-discretionary expenditure that is taken out of the budget first.
		/// </summary>
		/// ----------------------------------------------------------------------------------------
		...
		///////////////////////////////////////////////////////////////////////////////////////////
		/// <summary>
		///     Should contracts reward reputation instead of funds? Typically, this is what you want
		///     to do to fit with the philosophy of this mod.
		/// </summary>
		/// ----------------------------------------------------------------------------------------
		...
		///////////////////////////////////////////////////////////////////////////////////////////
		/// <summary>
		///     Should non-discretionary costs that happen to exceed the current budget be forgiven
		...
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////
		/// <summary>
		///     Records if this mod has not yet been run. Some initial setups are necessary in such a case. This
		///     value should start as 'true'.
		/// </summary>
		...
		///////////////////////////////////////////////////////////////////////////////////////////
		/// <summary>
		///     Should a hit to reputation occur if a Kerbal is killed? As with all reputation hits,
		///     it hurts the most when the reputation level is highest since gaining reputation
		///     at high levels is extremely difficult.
		/// </summary>
		/// ----------------------------------------------------------------------------------------
		...
		///////////////////////////////////////////////////////////////////////////////////////////
		/// <summary>
		///     Should Kerbals be paid wages? Wages are a non-discretionary expenditure that is taken
		...
		///////////////////////////////////////////////////////////////////////////////////////////
		/// <summary>
		///     Should costs for each launch (to cover wear-n-tear on launch facility) be charged
		///     whenever a vessel is launched? Heavy vessels, and particularly with the launch-
		///     pad, cause the launch costs to increase. This cost is a one-time charge.
		/// </summary>
		/// ----------------------------------------------------------------------------------------
		...
		///////////////////////////////////////////////////////////////////////////////////////////
		/// <summary>
		///     Is reputation decay per budget period enabled? Reputation decay means the player must
		///     always pat attention to reputation and perform missions as necessary to keep the
		///     reputation level sustained.
		/// </summary>
		/// ----------------------------------------------------------------------------------------
		...
		///////////////////////////////////////////////////////////////////////////////////////////
		/// <summary>
		///     The number of reputation points (per Kerbal XP level) to reduce when a Kerbal is
		///     killed.
		/// </summary>
		/// ----------------------------------------------------------------------------------------
		...
		///////////////////////////////////////////////////////////////////////////////////////////
		/// <summary>
		///     The launch costs per 100t on the launch-pad. Essentially this is the rocket launch
		...
		///////////////////////////////////////////////////////////////////////////////////////////
		/// <summary>
		///     The launch costs per 100t on the runway. Essentially this is the space-plane launch
		...
		///////////////////////////////////////////////////////////////////////////////////////////
		/// <summary>
		///     The minimum reputation to use when calculating gross budget. There is always a loyal
		///     cadre within the Kerbal government that ensures a minimum budget.
		/// </summary>
		/// ----------------------------------------------------------------------------------------
		...
		///////////////////////////////////////////////////////////////////////////////////////////
		/// <summary>
		///     The number of reputation points deducted per budget period if reputation decay has
		///     been enabled.
		/// </summary>
		/// ----------------------------------------------------------------------------------------
		...
		///////////////////////////////////////////////////////////////////////////////////////////
		/// <summary>
		///     When diverting budget to create science points, this is the number of credits it
		///     takes to create one science point.
		/// </summary>
		/// ----------------------------------------------------------------------------------------
		public int sciencePointCost = 10000;

		public int structureCostAdministration = 4000; // Administration Structure
		public int structureCostAstronautComplex = 2000; // Astronaut Complex
		public int structureCostMissionControl = 6000; // Mission Control Structure
		public int structureCostOtherFacility = 5000; // Other structures (added by mods)
		public int structureCostRnD = 8000; // Research & Development Structure
		public int structureCostSph = 8000; // Space-Plane Hangar
		public int structureCostTrackingStation = 4000; // Tracking-Station
		public int structureCostVab = 8000; // Vehicle Assembly Building
		...
		public void OnSave(ConfigNode savedNode)
		{
			...
			//savedNode.SetValue("MasterSwitch", masterSwitch, true);
		...
		public void OnLoad(ConfigNode node)
		{
			...
			//node.TryGetValue("MasterSwitch", ref masterSwitch);
		...
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////
		/// <summary> Called when the mod is run for the first time. It will default to the normal difficulty settings.</summary>
		...
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////
		/// <summary>
		///     Loads the settings from a file. The settings loaded are the recommended settings for the
